...
Original file is located at
    https://colab.research.google.com/drive/1-itwyJpEdw6AsFBwP3pezgOnlQ7ej7Ht
...
age = input("Enter your age: e")
sentence = f"Your name is {name} {surname}, and you are {age} years old."
print(sentence)
...
# Initialize the variable for the Polish grade
polish_grade = None

# Convert the score to the Polish grading system
if 0 <= score < 50:
    polish_grade = 2
elif 50 <= score < 60:
    polish_grade = 3
    ...
    print("Invalid score. The score should be between 0 and 100.")

# Print the Polish grade if it's valid
if polish_grade is not None:
    print(f"The Polish grade is: {polish_grade}")
...
if num2 != 0:
  if num1 % num2 == 0:
    print(f"{num1} can be evenly divided by {num2}.")
  else:
    print(f"{num1} cannot be evenly divided by {num2}.")
else:
...
# Check the type of triangle
  ...
  print("Triangle cannot be created with the given values.")
...
if operation == "+":
  ...
  if num2 != 0:
    result = num1 / num2
  else: "Illegal division, 2nd number cannot be 0."
else:
    result = "Invalid operation"
